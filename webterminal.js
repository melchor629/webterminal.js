...
(function() {
  "use strict";
  var $, Plugin, _this, append, conf, dirHelper, env, errorFormat, errorFormatNNL, getFormatting, getLine, help, newLine, parpadeo, pluginName, print, remove, shell, urlHelper, version, window;
  ...
  print = function(str) {
    var color, fmt, newStr, num, pos, pos2;
    color = null;
    while (str.match(/\x1B/)) {
      pos = str.indexOf('\x1B');
      if (str.charAt(pos + 1) === '[') {
